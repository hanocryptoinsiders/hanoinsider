...
export const INSIGHT_CATALOG: CatalogItem[] = [
  ...
  { id: "ins-3", img: "/assets/hanoinfrontend/cardBg.png", tag: "Altcoins", title: "Altcoin rotation index - where capital is moving", body: "Mid-caps catching the bid. This is what late-cycle looks like.", time: "8h ago", read: "5 min", likes: 76, comments: 19 },
  ...
  { id: "ins-6", img: "/assets/hanoinfrontend/cardBg.png", tag: "Trading", title: "Three setups I'm watching this week", body: "Two longs, one short. Defined invalidation on each.", time: "2d ago", read: "7 min", likes: 154, comments: 27 },
...
export const ARTICLE_CATALOG: CatalogItem[] = [
  ...
  { id: "art-3", img: "/assets/hanoinfrontend/cardBg.png", tag: "ETHEREUM", title: "The L2 thesis revisited - three years in", read: "14 min", date: "May 5" },
  ...
  { id: "art-6", img: "/assets/hanoinfrontend/cardBg.png", tag: "ALTCOINS", title: "Anatomy of a meta - RWA in real numbers", read: "7 min", date: "Apr 24" },
];
...
export const VIDEO_CATALOG: CatalogItem[] = [
  ...
  { id: "vid-3", img: "/assets/hanoinfrontend/cardBg.png", title: "Macro framework: liquidity & flows", dur: "31:08", date: "May 5", tag: "MACRO", progress: 84 },
  ...
  { id: "vid-6", img: "/assets/hanoinfrontend/cardBg.png", title: "The case for ETH/BTC reversal", dur: "16:12", date: "Apr 22", tag: "ANALYSIS", progress: 0 },
];
